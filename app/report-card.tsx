import { shown, shownClean, parseAddress, shouldShowPlace, type Person } from '@/lib/records';

export function Card({ person: p, number }: { person: Person; number: number }) {
    const showPlace = shouldShowPlace(p.place);
    ...
    return (
        <article className="record-card">
            ...
            <div className="record-lines">
                ...
                {showPlace && <p><b>Local de votação:</b> {shown(p.place)}</p>}
